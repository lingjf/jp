struct h2_sentence : std::vector<h2_string> {
   h2_sentence() {}
   h2_sentence(const char* a) : std::vector<h2_string>({a}) {}
   h2_sentence(const h2_string& a) : std::vector<h2_string>({a}) {}
   h2_sentence(std::initializer_list<h2_string> il) : std::vector<h2_string>(il) {}
